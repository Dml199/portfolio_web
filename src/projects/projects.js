...
export default function Projects () {
    ...
    return (<div id= "projects">
        <div className="card" onMouseEnter={()=>{setToggleOnTimer()}}><Anim /><div className={state?"dont_display":"display_message"} >Click on me to get to GitHub repository</div><img className="img" src={api}></img><h2 className="cardHeader">API integrattion</h2><h4 className="card_description">Building applications using wide variety of API.</h4></div>
